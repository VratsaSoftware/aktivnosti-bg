...
return [
    ...
    */
    ...
    'unique'               => 'Този :attribute вече съществува.',
    'uploaded'             => 'Неуспешно качване на :attribute.',
    'url'                  => 'Полето :attribute е в невалиден формат.',
    'uuid'                 => ':attribute трябва да бъде валиден UUID.',
    'phone_format'         => 'Полето телефон може да съдържа само цифри, без разстояние!',
    ...
    */
    ...
    'attributes' => [
        ...
        'delivery'                 => 'Доставка',
        'discount_percentage'      => 'Отстъпка в проценти',
        'discount_amount'          => 'Отстъпка сума',
        'type'                     => 'Тип',
