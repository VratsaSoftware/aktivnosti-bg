...
@section('title', 'Създаване на подкатегория към категория '.$category->name)
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('subcategory.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Име на подкатегория') }}</label>
